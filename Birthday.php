...
<a href="images/bakery-logo.jpg" class="logo">
<img src="images/bakery-logo.jpg" alt="company logo" style="width:100px;height:80px;">HomeBaked</a >
...
<h4> Explore the delicious cakes!!!</h4>

<br><br><br>

<hr>

<div class="heading">Vanilla cakes!! </div>
...
$sql = "SELECT * FROM products WHERE procategory = 'vanilla-cakes'"; $result = $conn->query($sql);
...
<div class="heading">Chocolate cakes!! </div>
...
$sql = "SELECT * FROM products WHERE procategory = 'chocolate-cakes'"; $result = $conn->query($sql);
...
<div class="heading">Birthday cakes for kids!! </div>
...
$sql = "SELECT * FROM products WHERE procategory = 'kid-cake'";
...
<a class='button' href='loginpage.php' style='margin-left: 90px;margin-right: 220px;padding-left: 200px;padding-right:200px; background-color:green'>Login Here</a></div>";
}
?>
</body>
</html>